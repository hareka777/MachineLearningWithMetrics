...
namespace MachineLearningWithMetrics.MLdotNET.Predictors
{
    public class EuroPredictor : IPredictor
    {
        ...
        internal override void EvaluateModel(ITransformer trainedModel)
        {
            ...
            _metrics.Measure.Gauge.SetValue(MetricsRegistry.TrainTestRate, MetricsTags.CreateMetricsTags(new string[] { "Network" }, new string[] { nameof(EuroPredictor) }), TrainTestDataRate);
